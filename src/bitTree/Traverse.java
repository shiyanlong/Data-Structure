...
import com.mo.bitTree.BitTreeNode;
import com.mo.bitTree.Visit;
...
public class Traverse {
	...
	public static void main(String[] args) throws Exception {
		...
		//打印二叉树
		com.mo.bitTree.Traverse.printBitTree(a, 0);
		//分别 先，中，后，层 遍历二叉树
		Visit vs = new Visit();
		System.out.print("先");
		com.mo.bitTree.Traverse.preOrder(a, vs);
		System.out.println();
		System.out.print("中");
		com.mo.bitTree.Traverse.inOrder(a, vs);
		System.out.println();
		System.out.print("后 ");
		com.mo.bitTree.Traverse.postOrder(a, vs);
		System.out.println();
		System.out.print("层");
		com.mo.bitTree.Traverse.levelOrder(a, vs);
		System.out.println();
		System.out.print("查找数值");
		BitTreeNode search = com.mo.bitTree.Traverse.search(a, "a");
