...
public class MyStringBuffer {
	...
	public com.mo.string.MyStringBuffer concat(com.mo.string.MyStringBuffer str) {
	...
	public static void main(String[] args) {
		com.mo.string.MyStringBuffer m1 = new com.mo.string.MyStringBuffer("abcde");
		com.mo.string.MyStringBuffer m2 = new com.mo.string.MyStringBuffer("fdhij");
		com.mo.string.MyStringBuffer m3 = m1.concat(m2);
		m3.myPrint();
		m1.myPrint();
		m2.myPrint();      
	}
