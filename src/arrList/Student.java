...
public class Student {
	...
	public static void main(String[] args) throws Exception {
		...
		com.mo.arrList.Student s1 = new com.mo.arrList.Student(200001,"张三","男",20);
		com.mo.arrList.Student s2 = new com.mo.arrList.Student(200002,"李四","男",21);
		com.mo.arrList.Student s3 = new com.mo.arrList.Student(200003,"王五","女",22);
		seqList.insert(0, s1);
		seqList.insert(1, s2);
		seqList.insert(2, s3);
